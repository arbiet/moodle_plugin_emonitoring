...
$gradeitemoptions = [];
$gradeitemoptions = ['none' => get_string('nogradeitem', 'block_completion_progress')]; // Default no grade item
foreach ($grade_items as $item) {
    $gradeitemoptions[$item->id] = $item->itemname;
}
echo $output->single_select($PAGE->url, 'gradeitemid', $gradeitemoptions, $gradeitemid,
    ['' => 'choosedots'], null, ['label' => get_string('gradeitem', 'block_completion_progress')]);
echo $output->container_end();
