...
/**
 * E-Monitoring block English language translation
 *
 * @package    block_completion_progress
 * @copyright  2024 Amalia Puspitasari
...
$string['completion_progress:addinstance'] = 'Add a new E-Monitoring block';
$string['completion_progress:myaddinstance'] = 'Add an E-Monitoring block to My home page';
$string['completion_progress:overview'] = 'View course overview of E-Monitoring for all students';
$string['completion_progress:showbar'] = 'Show the bar in the E-Monitoring block';
$string['config_activitiesincluded'] = 'Activities included';
$string['config_activitycompletion'] = 'All activities with completion set';
$string['config_default_title'] = 'E-Monitoring';
...
$string['how_group_works_help'] = '<p>Selecting a group or grouping will limit the display of this block to that group or grouping only.</p>';
...
$string['how_ordering_works_help'] = '<p>There are two ways to order activities in the E-Monitoring block.</p><ul><li><em>Time using "Expect completion on" date</em> (default)<br />The expected completion dates of activities/resources are used to order the bar. Where activities/resources don\'t have an expected completion date, ordering in the course is used instead. When this option is used, the NOW indicator is shown.</li><li><em>Ordering in course</em><br />Activities/resources are presented in the same order as they are on the course page. When this option is used, expected completion dates are ignored. When this option is used, the NOW indicator is not shown.</li></ul>';
$string['how_selectactivities_works'] = 'How including activities works';
$string['how_selectactivities_works_help'] = '<p>To manually select activities to be included in the bar, ensure that "Activities included" is set to "selected activities".</p><p>Only activities with activity completion settings set can be included.</p><p>Hold the CTRL key to select multiple activities.</p>';
...
$string['no_blocks'] = 'No E-Monitoring blocks are set up for your courses.';
...
$string['pluginname'] = 'E-Monitoring';
$string['progress'] = 'Progress';
$string['progressbar'] = 'E-Monitoring';
$string['privacy:metadata'] = 'The E-Monitoring block only displays existing completion data.';
...
$string['why_set_the_title_help'] = '<p>There can be multiple instances of the E-Monitoring block. You may use different E-Monitoring blocks to monitor different sets of activities or resources. For instance you could track progress in assignments in one block and quizzes in another. For this reason you can override the default title and set a more appropriate block title for each instance.</p>';
...
$string['why_use_icons_help'] = '<p>You may wish to add tick and cross icons in the E-Monitoring to make this block more visually accessible for students with colour-blindness.</p><p>It may also make the meaning of the block clearer if you believe colours are not intuitive, either for cultural or personal reasons.</p>';
$string['wrapafter'] = 'When wrapping, limit rows to';
$string['not_completed'] = 'Not completed';
$string['completed'] = 'Completed';
$string['kelompok'] = 'Group Student';
$string['nilai'] = 'Nilai';
$string['grade_col'] = 'Grade Col';
$string['gradeitem'] = 'Grade Items';
$string['nogradeitem'] = 'No Grade Items';
